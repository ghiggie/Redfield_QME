...
!---------------------------------------------------------------------!
    ...
    namelist/params/dt1,dt2,time_limit,trunc,temp,gamma,lambda,rho0,HS,VI
    ...
    do i = 0, N - 1
        t_i = i * dt1
        ! Calculate k1
        k1 = rk4_int(t_i,dt2,VI,temp,lambda,gamma)
        ! Calculate k2
        k2 = rk4_int(t_i+dt1/2,dt2,VI,temp,lambda,gamma)
        ! Calculate k3
        k3 = k2
        ! Calculate k4
        k4 = rk4_int(t_i+dt1,dt2,VI,temp,lambda,gamma)
        ! Calculate rho(i+1)
